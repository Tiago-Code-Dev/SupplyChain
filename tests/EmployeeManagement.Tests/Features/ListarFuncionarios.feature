...
Funcionalidade: Listagem de Funcionários
  ...
  Cenário: Listar funcionários com filtro por permissão
    ...
    E que existem funcionários cadastrados:
      ...
      | Maria | Leader   |
      | Pedro | Director     |
    Quando o usuário solicita a listagem de funcionários com filtro por permissão "Leader"
    Então o sistema deve retornar status 200
    E o sistema deve retornar apenas funcionários com permissão "Leader"
